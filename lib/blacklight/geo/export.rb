module BlacklightGeo
  ...
  class GeojsonExport
    ...
    def type
      blacklight_geo_config.type
    end

    def placename_coord_field
      blacklight_geo_config.placename_coord_field
    end

    def placename_coord_delimiter
      blacklight_geo_config.placename_coord_delimiter
    end

    def bbox_field
      blacklight_geo_config.bbox_field
    end
