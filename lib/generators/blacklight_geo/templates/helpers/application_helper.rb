...
def layer_type_image(type)
  case type
  when "Polygon"
    image_tag('type_polygon.png', 'data-toggle' => 'tooltip', title: 'Polygon', :class => 'tooltip-icon')
  when "Line"
    image_tag('type_arc.png', 'data-toggle' => 'tooltip', title: 'Line', :class => 'tooltip-icon')
  when "Point"
    image_tag('type_dot.png', 'data-toggle' => 'tooltip', title: 'Point', :class => 'tooltip-icon')
  when "Raster"
    image_tag('type_raster.png', 'data-toggle' => 'tooltip', title: 'Raster', :class => 'tooltip-icon')
  when "Paper Map"
    image_tag('type_map.png', 'data-toggle' => 'tooltip', title: 'Paper Map', :class => 'tooltip-icon')
  when "LibraryRecord"
...
def layer_institution_image(institution)
  case institution
  when /Stanford/
    image_tag('src_stanford.png', 'data-toggle' => 'tooltip', title: 'Stanford', :class => 'tooltip-icon')
  when /Berkeley/
    image_tag('src_berkeley.png', 'data-toggle' => 'tooltip', title: 'UC Berkeley', :class => 'tooltip-icon')
  when /Harvard/
    image_tag('src_harvard.png', 'data-toggle' => 'tooltip', title: 'Harvard', :class => 'tooltip-icon')
  when /MIT/
    image_tag('src_mit.png', 'data-toggle' => 'tooltip', title: 'MIT', :class => 'tooltip-icon')
  when /Tufts/
    image_tag('src_tufts.png', 'data-toggle' => 'tooltip', title: 'Tufts', :class => 'tooltip-icon')
  when /MassGIS/
    image_tag('src_massgis.png', 'data-toggle' => 'tooltip', title: 'MassGIS', :class => 'tooltip-icon')
  else
    ""
  end
end
